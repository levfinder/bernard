# Generated by Django 2.1.2 on 2018-10-20 09:29

import bernard.core.enums
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(bernard.core.enums.DeliveryStatusEnum('Scheduled'), 'Scheduled'), (bernard.core.enums.DeliveryStatusEnum('In progress'), 'In progress'), (bernard.core.enums.DeliveryStatusEnum('Complete'), 'Complete'), (bernard.core.enums.DeliveryStatusEnum('Cancelled'), 'Cancelled')], max_length=8)),
            ],
        ),
        migrations.CreateModel(
            name='Location',
